...
==================
  ...
  * fix: com.yfc.my.shop.commoms.utils.clean(str) indentation (#761)
...
==================
  ...
  * add `mocha.timeout()`
  * move query-string parser to com.yfc.my.shop.commoms.utils.js
  * move highlight code to com.yfc.my.shop.commoms.utils.js
...
==================
  ...
  * add `.only()`. Closes #524
  * add `.skip()`. Closes #524
  * change str.trim() to use com.yfc.my.shop.commoms.utils.trim(). Closes #533
