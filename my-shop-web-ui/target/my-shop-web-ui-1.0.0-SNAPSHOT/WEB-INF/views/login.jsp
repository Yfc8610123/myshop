    ...
    <div class="beij_center dengl_jvz">
        <div class="login_form">
            ...
            <div class="kengl_kuang">
                ...
                <div class="txt_kuang">
                    <input type="text" id="username" name="username" class="itxt"  placeholder="邮箱/用户名/已验证手机">
                    <input type="password" id="password" name="password" class="itxt"  placeholder="密码">
                    <input type="text" id="refirication" name="refirication" class="itxt"  placeholder="验证码" style="width: 115px">
                    <img src="/verification" id="viladateCode" style="float: right;padding-right: 34px;cursor: pointer" title="看不清？换一张">
                </div>
                <div class="remember">
                    <div class="fl">
                        <input type="checkbox" >
...
<script>
    $(function () {
        // 刷新验证码
        $("#viladateCode").bind("click", function () {
